...
from vdk.ctos.anonymizer import Anonymizer
from vdk.ctos.ingester_plugin import AnonymizationIngesterPlugin
...
def initialize_job(context: JobContext) -> None:
    ...
    anonymization_fields = context.core_context.configuration.get_value("anonymization_fields")
    anonymization_fields = json.loads(anonymization_fields)
    context.ingester.add_ingester_factory_method("anonymize", lambda: AnonymizationIngesterPlugin(anonymization_fields, Anonymizer()))
