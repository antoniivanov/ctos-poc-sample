...
from vdk.plugin.test_utils.util_funcs import cli_assert_equal, jobs_path_from_caller_directory
from vdk.plugin.test_utils.util_plugins import IngestIntoMemoryPlugin

from vdk.ctos import anonymization_plugin
...
def test_anonymization_ingestion():
    ...
    result: Result = runner.invoke(["run", jobs_path_from_caller_directory("ingest-job")])
    cli_assert_equal(0, result)

    actual_payload = destination_plugin.payloads[0].payload
    expected_payload = [
        {"str_key": "str", "sensitive_key": "a46e1b9d0e3467d52e2dfc2e902f6c3f8c3529dde2df62652a25b4d4aebae5af"},
        {'str_key': 'str', 'sensitive_key': 'd64e011391b12310cb932f47f9464d53367e5378e2d6900aa56495fba238d65c'}
    ]
